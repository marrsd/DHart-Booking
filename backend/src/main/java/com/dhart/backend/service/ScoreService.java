...
public class ScoreService {
    ...
    @Autowired
    public ScoreService(ScoreRepository scoreRepository, IUsuariosRepository usuariosRepository,
    ...
    public void saveScore(ScoreDTO scoreDto) throws NotFoundException {
        ...
        Score score = ScoreMapper.scoreDTOtoScore(null, (Product) data.get("Product"), (Usuarios) data.get("User"),
                scoreDto.getScore());

        Optional<Score> scoreDB = scoreRepository.findScoreByProductIdAndUserId(scoreDto.getProductId(),
                scoreDto.getUserId());
